...
alias c='clear'
alias aegit='git config user.email "kornelije.sajler@aenetworks.com" && git config user.name "Kornelije Sajler"'
alias xgit='git config user.email "x@x430n.com" && git config user.name "x430n"'
alias nf='clear && fastfetch'
alias ae='cd $HOME/src/ae'
alias 4ssh='TERM=xterm-256color ssh 109.235.65.246 -p 30'
alias ragssh='TERM=xterm-256color ssh rag@185.254.253.156'
alias pingme="ping -c 3 430n.com"
...
alias poa="pulumi org set-default aenetworks"
alias pos="pulumi org set-default aenetworks-sandbox"
alias bu="brew update && brew upgrade --greedy && brew autoremove && brew cleanup" # && mas upgrade"
alias pcv="cat sdks/aenetworks-aetn-ecs-fargate-service/package.json | grep '\"version\"'"
